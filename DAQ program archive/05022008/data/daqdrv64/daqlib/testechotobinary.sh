...
"input samplerate=1000.e3 channels=8 nrows=10000 vfs=5 mode=singleended clock=internal" \
trigger=software \
"writereaddma trigger binary echotobinary.data"

echo "converting to ascii"
./binarytoascii echotobinary.data > echotobinary.ascii
